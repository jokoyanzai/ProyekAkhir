...
object BooksData
{
    ...
    private val bookCovers = intArrayOf(
        R.drawable.why_we_sleep,
        R.drawable.the_science_book,
        R.drawable.essential_grammar,
        R.drawable.the_intelligent_investor,
        R.drawable.atomic_habits,
        R.drawable.ikigai,
        R.drawable.python_crash_course,
        R.drawable.finish_what_you_start,
        R.drawable.the_psychology_of_money,
        R.drawable.twelve_rules_for_life
    )

    private val bookDesc = arrayOf(
        "\"Sleep is one of the most important but least understood aspects of our life, wellness, and longevity ... An explosion of scientific discoveries in the last twenty years has shed new light on this fundamental aspect of our lives. Now ... neuroscientist and sleep expert Matthew Walker gives us a new understanding of the vital importance of sleep and dreaming\"--Amazon.com.",
        "Provides a visual introduction to the disciplines of astronomy, biology, chemistry, geology, and physics, helping to break down complicated ideas into manageable concepts.",
    ...
    private val bookCategories = arrayOf(
        ...
        "Self-Help, Relationships & Lifestyle - Personal Growth",
        "Self-Help, Relationships & Lifestyle - Aging",
    ...
    private val bookLanguages = arrayOf(
        "English",
        "English",
        "English",
        "English",
    ...
    private val bookYears = intArrayOf(
        2017,
        2014,
        2015,
        2003,
    ...
    private val bookPages = intArrayOf(
        368,
        354,
        318,
        641,
    ...
    val listData: ArrayList<Book>
        get()
        {
            ...
            for (position in bookTitles.indices)
            {
                ...
                book.cover = bookCovers[position]
                book.desc = bookDesc[position]
                book.category = bookCategories[position]
                book.language = bookLanguages[position]
                book.publisher = bookPublishers[position]
                book.year = bookYears[position]
